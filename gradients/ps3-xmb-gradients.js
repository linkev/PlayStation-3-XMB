...
export const PS3_XMB_GRADIENTS = {
  "january_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0824, 0.0824, 0.0824] },
      { position: 0.5000, color: [0.0980, 0.0980, 0.0980] },
      { position: 0.5000, color: [0.3216, 0.3216, 0.3216] },
      { position: 0.5000, color: [0.3255, 0.3255, 0.3255] },
      { position: 0.5000, color: [0.6157, 0.6157, 0.6157] },
      { position: 0.5000, color: [0.7176, 0.7176, 0.7176] },
    ],
    quality: 0.8500,
  ...
  "february_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0824, 0.0941, 0.0510] },
      { position: 0.5000, color: [0.0941, 0.0980, 0.0667] },
      { position: 0.5000, color: [0.3373, 0.3098, 0.2000] },
      { position: 0.5000, color: [0.3412, 0.3137, 0.2039] },
      { position: 0.5000, color: [0.6196, 0.5922, 0.3608] },
      { position: 0.5000, color: [0.7176, 0.6824, 0.4510] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "march_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0706, 0.0745, 0.0431] },
      { position: 0.5000, color: [0.0745, 0.0863, 0.0549] },
      { position: 0.5000, color: [0.2706, 0.2980, 0.1961] },
      { position: 0.5000, color: [0.2784, 0.3059, 0.2078] },
      { position: 0.5000, color: [0.5137, 0.5804, 0.3804] },
      { position: 0.5000, color: [0.5725, 0.6471, 0.4275] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "april_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0745, 0.0588, 0.0627] },
      { position: 0.5000, color: [0.1294, 0.1098, 0.1176] },
      { position: 0.5000, color: [0.4275, 0.3412, 0.3529] },
      { position: 0.5000, color: [0.4275, 0.3412, 0.3569] },
      { position: 0.5000, color: [0.7176, 0.5882, 0.6157] },
      { position: 0.5000, color: [0.7922, 0.6549, 0.6784] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "may_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0627, 0.1373, 0.0510] },
      { position: 0.5000, color: [0.0902, 0.1647, 0.0863] },
      { position: 0.5000, color: [0.1098, 0.1961, 0.1098] },
      { position: 0.5000, color: [0.0980, 0.1725, 0.0941] },
      { position: 0.5000, color: [0.1176, 0.2824, 0.1216] },
      { position: 0.5000, color: [0.1373, 0.2980, 0.1412] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "june_night": {
    ...
    theme: "night",
    type: "linear",
    direction: [0.0932, 0.2120],
    colorStops: [
      { position: 0.5000, color: [0.0314, 0.0392, 0.0353] },
      { position: 0.5000, color: [0.0941, 0.0824, 0.1059] },
      { position: 0.5000, color: [0.3529, 0.2863, 0.4118] },
      { position: 0.5000, color: [0.3569, 0.2863, 0.4078] },
      { position: 0.5000, color: [0.6980, 0.5412, 0.7490] },
      { position: 0.5000, color: [0.7843, 0.6078, 0.8314] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "july_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0549, 0.0784, 0.0784] },
      { position: 0.5000, color: [0.0706, 0.0980, 0.1020] },
      { position: 0.5000, color: [0.0667, 0.2235, 0.2196] },
      { position: 0.5000, color: [0.0588, 0.1961, 0.1843] },
      { position: 0.5000, color: [0.0392, 0.3176, 0.3020] },
      { position: 0.5000, color: [0.0549, 0.2980, 0.2863] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "august_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0000, 0.0078, 0.1059] },
      { position: 0.5000, color: [0.0078, 0.0000, 0.1922] },
      { position: 0.5000, color: [0.0039, 0.1686, 0.3686] },
      { position: 0.5000, color: [0.0039, 0.2314, 0.3882] },
      { position: 0.5000, color: [0.0118, 0.4980, 0.5765] },
      { position: 0.5000, color: [0.0078, 0.5373, 0.6118] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "september_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0980, 0.0000, 0.1137] },
      { position: 0.5000, color: [0.1216, 0.0000, 0.1529] },
      { position: 0.5000, color: [0.2235, 0.0000, 0.2706] },
      { position: 0.5000, color: [0.2549, 0.0000, 0.3098] },
      { position: 0.5000, color: [0.3765, 0.0000, 0.4902] },
      { position: 0.5000, color: [0.4157, 0.0039, 0.5608] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "october_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0275, 0.0000, 0.0118] },
      { position: 0.5000, color: [0.0588, 0.0275, 0.0000] },
      { position: 0.5000, color: [0.3333, 0.2000, 0.0000] },
      { position: 0.5000, color: [0.3412, 0.2078, 0.0000] },
      { position: 0.5000, color: [0.7294, 0.4706, 0.0196] },
      { position: 0.5000, color: [0.8353, 0.5765, 0.0039] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "november_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0824, 0.0627, 0.0510] },
      { position: 0.5000, color: [0.1137, 0.0941, 0.0667] },
      { position: 0.5000, color: [0.2941, 0.2039, 0.0980] },
      { position: 0.5000, color: [0.2941, 0.2039, 0.0980] },
      { position: 0.5000, color: [0.4471, 0.2863, 0.1059] },
      { position: 0.5000, color: [0.4980, 0.3373, 0.1647] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "december_night": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0627, 0.0627, 0.0549] },
      { position: 0.5000, color: [0.0627, 0.0510, 0.0392] },
      { position: 0.5000, color: [0.2000, 0.1137, 0.0980] },
      { position: 0.5000, color: [0.1529, 0.0784, 0.0824] },
      { position: 0.5000, color: [0.2980, 0.1529, 0.1176] },
      { position: 0.5000, color: [0.2510, 0.1373, 0.1059] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "january_rgb": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.7216, 0.7216, 0.7216] },
      { position: 0.5000, color: [0.8039, 0.8039, 0.8039] },
      { position: 0.5000, color: [0.7569, 0.7569, 0.7569] },
      { position: 0.5000, color: [0.7098, 0.7098, 0.7098] },
      { position: 0.5000, color: [0.7608, 0.7608, 0.7608] },
      { position: 0.5000, color: [0.9020, 0.9020, 0.9020] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "february_rgb": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.8353, 0.8667, 0.1961] },
      { position: 0.5000, color: [0.8549, 0.8196, 0.1490] },
      { position: 0.5000, color: [0.8078, 0.6627, 0.0667] },
      { position: 0.5000, color: [0.7922, 0.6353, 0.0471] },
      { position: 0.5000, color: [0.8000, 0.6549, 0.0667] },
      { position: 0.5000, color: [0.8196, 0.7490, 0.1294] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "march_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.3569, 0.6235, 0.0941] },
      { position: 0.5000, color: [0.4471, 0.7176, 0.0902] },
      { position: 0.5000, color: [0.4353, 0.6784, 0.1020] },
      { position: 0.5000, color: [0.4157, 0.6667, 0.0980] },
      { position: 0.5000, color: [0.4863, 0.7412, 0.1373] },
      { position: 0.5000, color: [0.5059, 0.7529, 0.1608] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "april_rgb": {
    ...
    colorStops: [
      { position: 0.0000, color: [0.2000, 0.2000, 0.3000] },
      { position: 1.0000, color: [0.1000, 0.1000, 0.2000] },
    ],
    quality: 0.8500,
    glslFunction: `
...
vec3 getGradientColor(vec2 uv) {
  ...
  "may_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.0863, 0.5922, 0.0941] },
      { position: 0.5000, color: [0.0824, 0.5608, 0.0863] },
      { position: 0.5000, color: [0.0902, 0.5451, 0.0941] },
      { position: 0.5000, color: [0.0824, 0.4941, 0.0863] },
      { position: 0.5000, color: [0.0863, 0.4627, 0.0824] },
      { position: 0.5000, color: [0.0706, 0.4235, 0.0784] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "june_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.5176, 0.3647, 0.8549] },
      { position: 0.5000, color: [0.5373, 0.3686, 0.8471] },
      { position: 0.5000, color: [0.6275, 0.4157, 0.8627] },
      { position: 0.5000, color: [0.5804, 0.3804, 0.7922] },
      { position: 0.5000, color: [0.6235, 0.3647, 0.7137] },
      { position: 0.5000, color: [0.5686, 0.3255, 0.6196] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "july_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.0510, 0.9098, 0.8941] },
      { position: 0.5000, color: [0.0314, 0.8706, 0.8627] },
      { position: 0.5000, color: [0.0196, 0.8235, 0.7922] },
      { position: 0.5000, color: [0.0000, 0.7725, 0.7333] },
      { position: 0.5000, color: [0.0000, 0.7255, 0.6353] },
      { position: 0.5000, color: [0.0039, 0.6706, 0.5647] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "august_rgb": {
    ...
    colorStops: [
      { position: 0.5000, color: [0.0392, 0.6902, 0.8784] },
      { position: 0.5000, color: [0.1020, 0.6863, 0.8510] },
      { position: 0.5000, color: [0.0392, 0.4549, 0.7255] },
      { position: 0.5000, color: [0.0431, 0.3686, 0.7137] },
      { position: 0.5000, color: [0.0000, 0.0745, 0.4196] },
      { position: 0.5000, color: [0.0000, 0.0275, 0.3098] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "september_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.6706, 0.2588, 0.7647] },
      { position: 0.5000, color: [0.7137, 0.2706, 0.7922] },
      { position: 0.5000, color: [0.6824, 0.2431, 0.7373] },
      { position: 0.5000, color: [0.7255, 0.2824, 0.7686] },
      { position: 0.5000, color: [0.7255, 0.2941, 0.7686] },
      { position: 0.5000, color: [0.7922, 0.3647, 0.8627] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "october_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.8902, 0.6980, 0.0902] },
      { position: 0.5000, color: [0.8902, 0.6784, 0.0235] },
      { position: 0.5000, color: [0.8824, 0.6392, 0.0314] },
      { position: 0.5000, color: [0.8784, 0.6431, 0.0314] },
      { position: 0.5000, color: [0.8824, 0.6588, 0.0471] },
      { position: 0.5000, color: [0.8863, 0.6902, 0.0588] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "november_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.5961, 0.4510, 0.1765] },
      { position: 0.5000, color: [0.5922, 0.4392, 0.1765] },
      { position: 0.5000, color: [0.5255, 0.3569, 0.1216] },
      { position: 0.5000, color: [0.5255, 0.3569, 0.1216] },
      { position: 0.5000, color: [0.4745, 0.2941, 0.0941] },
      { position: 0.5000, color: [0.4667, 0.2863, 0.0863] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
  ...
  "december_rgb": {
    ...
    direction: [1.0000, 0.0000],
    colorStops: [
      { position: 0.5000, color: [0.8980, 0.2627, 0.1725] },
      { position: 0.5000, color: [0.9059, 0.2627, 0.1647] },
      { position: 0.5000, color: [0.8941, 0.2588, 0.1765] },
      { position: 0.5000, color: [0.8824, 0.2510, 0.1686] },
      { position: 0.5000, color: [0.8784, 0.2549, 0.1725] },
      { position: 0.5000, color: [0.8353, 0.2588, 0.1804] },
    ],
    quality: 0.8500,
    glslFunction: `vec3 getGradientColor(vec2 uv) {
    float t = dot(uv, vec2(-0.0000, 0.0000));
...
export const AVAILABLE_MONTHS = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"];
